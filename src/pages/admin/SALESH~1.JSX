...
export default function SalesHistory() {
  ...
  useEffect(() => { fetchSales() }, [dateFrom, dateTo, filter, statusFilter, branchFilter])
  ...
  const totals = filtered.filter(s => s.status === 'completed').reduce((acc, s) => {
    ...
    return acc
  }, { ventas: 0, descuentos: 0, count: 0, efectivo: 0, tarjeta: 0, transferencia: 0, plataforma: 0 })
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: 'Efectivo',      value: totals.efectivo,      color: 'text-green-700',  bg: 'bg-green-50'  },
          { label: 'Tarjeta',       value: totals.tarjeta,       color: 'text-blue-700',   bg: 'bg-blue-50'   },
          { label: 'Transferencia', value: totals.transferencia, color: 'text-cyan-700',   bg: 'bg-cyan-50'   },
          { label: 'Plataformas',   value: totals.plataforma,    color: 'text-purple-700', bg: 'bg-purple-50' },
        ].map(item => (
