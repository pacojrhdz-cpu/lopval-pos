...
export default function SalesHistory() {
  ...
  // Filtro de método aplicado en cliente
  ...
  // Tarjetas de resumen: respetan filtro de método + búsqueda
  ...
  // Desglose por método: SIEMPRE usa todos los datos del periodo (sin filtro de método)
  // para que los montos sean consistentes sin importar qué categoría esté seleccionada
