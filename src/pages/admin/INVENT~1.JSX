...
export default function Inventory() {
  ...
  async function fetchAll() {
    ...
    const { data: mov, error: movErr } = await movQ
    if (movErr) console.error('[Inventory] movements error:', movErr.message)
    else console.log('[Inventory] movements count:', mov?.length, 'branch:', branchId)
