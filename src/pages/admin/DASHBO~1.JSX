...
// Convierte rango de fechas a UTC respetando hora local (evita bug de timezone)
...
export default function Dashboard() {
  ...
  useEffect(() => { fetchStats() }, [dateFrom, dateTo, selBranch])
  ...
  const displayPeriod = isToday
    ? new Date(TODAY + 'T12:00:00').toLocaleDateString('es-MX', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })
    : `${dateFrom} — ${dateTo}`
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm capitalize">{displayPeriod}</p>
        </div>
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        {[
          ...
          { label: 'Esta semana', from: (() => { const d = new Date(); d.setDate(d.getDate() - d.getDay()); return d.toISOString().split('T')[0] })(), to: TODAY },
