...
const METHOD_LABELS = { efectivo: 'Efectivo', tarjeta: 'Tarjeta', transferencia: 'Transferencia', plataforma: 'Plataforma' }
const METHOD_COLORS = {
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-5">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm flex flex-wrap gap-3 items-center">
        ...
        <div className="flex gap-1">
          {['all','efectivo','tarjeta','transferencia','plataforma'].map(m => (
