      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="mb-2 w-52 h-36 flex items-center justify-center">
            <img src="/logo.svg" alt="Pizza & Totó" className="w-full h-full object-contain" />
          </div>
        ...
        <button
          ...
          className="mt-4 w-full flex items-center justify-center gap-2 border border-gray-300 hover:border-gray-400 text-gray-600 hover:text-gray-900 rounded-lg py-3 text-sm font-medium transition-colors"
